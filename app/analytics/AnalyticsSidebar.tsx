  ...
  return (
    <aside className="w-64 bg-white border-r border-slate-200 flex flex-col h-screen sticky top-0 shrink-0">
      ...
      <nav className="flex-1 px-4 py-4 space-y-1 flex flex-col">
        ...
        <Link href="/student-profile" className={pathname === "/student-profile" ? activeLinkClass : inactiveLinkClass}>
          <LayoutDashboard className="w-4 h-4" /> Dashboard
        </Link>
        <Link href="/profile" className={pathname === "/profile" ? activeLinkClass : inactiveLinkClass}>
          <Users className="w-4 h-4" /> Profile
        </Link>
        <Link href="/diagnostic-test" className={pathname === "/diagnostic-test" ? activeLinkClass : inactiveLinkClass}>
          <ClipboardList className="w-4 h-4" /> Tests
        </Link>
        <Link href="/analytics" className={pathname === "/analytics" ? activeLinkClass : inactiveLinkClass}>
